...
are abandoned wholesale (`EXPERIMENT_PLAN_R4.md` §1.3) — and **fixed prospectively**:
...
answer — `EXPERIMENT_PLAN_R4.md` §7 records the thread as explicitly out of scope,
...
`EXPERIMENT_PLAN_R4.md` §6. **They must be added to `references_verified.bib` and
