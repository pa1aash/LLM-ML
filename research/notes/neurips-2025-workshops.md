...
Tianlong Chen ⋅ Ang Li ⋅ Furong Huang ⋅ Avi Schwarzschild ⋅ Neil Gong ⋅ Bo Li ⋅ Yuxiong He
Dec 6, 8:00 AM - 5:00 PM
Upper Level Room 1AB
...
Dec 7, 8:00 AM - 5:00 PM
Upper Level Room 4
With most advances in large foundation models (LFMs) being empirical, our theoretical understanding of what transformers can compute, express, and learn still lags behind. This workshop will convene theorists and empiricists to chart a rigorous agenda for the next generation of LFMs, asking “What _can_ and _can’t_ transformers do?” We welcome both formal analyses and empirically grounded studies that shed light on theoretical questions, aiming to close the gap between proofs and practice while fostering new, interdisciplinary collaborations.
Show more
View full details
Workshop
...
More details are provided in our [Call for Papers](https://berts-workshop.github.io/call-for-papers/).
Show more
View full details
Workshop
...
View full details
Workshop
Geometry-adaptive Hyperbolic Learning in Computer Vision
Dec 7, 3:30 PM - 3:30 PM
View full details
No Events Found
