---
title: '[2401.10034v3] Evolutionary Computation in the Era of Large Language Model:
  Survey and Roadmap'
id: 240110034v3-evolutionary-computation-in-the-era-of-large-language-model-survey-a
tags:
- llm-nas-feedback-positioning-7125b1
- llm-nas-survey
created: '2026-08-16T15:45:07.946827Z'
updated: '2026-08-16T15:46:16.947448Z'
source: https://arxiv.org/abs/2401.10034v3
source_domain: arxiv.org
fetched_at: '2026-08-16T15:45:07.943688Z'
...
content_type: paper
deprecated: false
summary: Survey (Wu, Wu, Wu, Feng, Tan; first submitted Jan 2024, v3 May 2024) systematically
  reviewing the two-way interplay between LLMs and evolutionary algorithms (EAs),
  categorized as LLM-enhanced EA and EA-enhanced LLM, with neural architecture search
  named explicitly as one of the application domains alongside code generation and
  software engineering. Frames LLMs as providing domain knowledge to guide more intelligent
  EA search and EAs as providing a black-box optimization framework for LLM enhancement;
  positions itself as the first comprehensive review of EA research in the LLM era,
  useful for mapping where LLM-guided architecture/program search sits relative to
  the broader EA+LLM literature as of early-to-mid 2024.
---

[2401.10034v3] Evolutionary Computation in the Era of Large Language Model: Survey and Roadmap
...
v1
), last revised 29 May 2024 (this version, v3)]
Title:
...
,
Kay Chen Tan
View a PDF of the paper titled Evolutionary Computation in the Era of Large Language Model: Survey and Roadmap, by Xingyu Wu and 4 other authors
View PDF
HTML (experimental)
Abstract:
...
[cs.NE]
for this version)
https://doi.org/10.48550/arXiv.2401.10034
Focus to learn more
...
[v1]
Thu, 18 Jan 2024 14:58:17 UTC (222 KB)
[v2]
Wed, 7 Feb 2024 07:37:34 UTC (242 KB)
[v3]
Wed, 29 May 2024 09:00:25 UTC (256 KB)
Full-text links:
Access Paper:
View a PDF of the paper titled Evolutionary Computation in the Era of Large Language Model: Survey and Roadmap, by Xingyu Wu and 4 other authors
View PDF
...
Index Terms—evolutionary algorithm (EA), large language
...
across various research field [6]–[8]. Notably, this impact
...
different characteristics. Therefore, in terms of application
...
prompts and training data, leading to a tendency to gen-
...
arXiv:2401.10034v3  [cs.NE]  29 May 2024
...
scenarios, including NAS, code generation, software
...
evaluated and added to the prompt for the next iteration.
While this study does not explicitly define the ‘crossover’
and ‘mutation’ operators in evolutionary optimization, the
...
also constructs a prompt in each generation to guide the
...
2) Multi-objective optimization: In the field of multiob-
...
LLM learned how to select two solutions from the input
...
2) Iterative Generaiton: In the nascent stages of LLM
...
prehension, representation, and generation capabilities of
...
proposed an EA-based discrete Prompt tuning framework
...
goals in each phase, including global initialization phase
...
a uniform distribution but is adapted to different models
...
reinforcement learning methods [88], making the models
...
[98], [99]). Among them, the LLM plays the role of a
...
Through an EA, they searched for the optimal rescaling
...
[108]. Luo et al. applied the Evol-Instruct introduced in
...
By iteratively improving the code, these methods enable
...
For example, as introduced by Ma et al., the Evolution-
...
prompt as contextual information to effectively guide the
...
design [116].
3) Security in Code Generation: In addition to directly
...
produce a large number of input programs that meet the
...
ability to estimate new stories. However, the choice and
...
the highest fitness to input into LLM for news summary
...
molecular-input line-entry system (SMILES) string [154].
...
versions of their parents’ trait genes, thus simulating the
...
Generalized or Universal NAS
Possible Exploration for Higher-level Tasks
...
limited influencing factors, which are insufficient to fully
...
15
based on its knowledge, enabling EC to tackle complex prob-
...
be extensive. As the prompt length and vocabulary space
...
of combining LLM and EA on small-scale problems, the
...
use cases. Moreover, the code generated by LLM might
...
them, the design schemes and reports generated by LLM
...
is still in its early and fragmented stages. Areas beyond
...
diversity through ai feedback,” in Proceedings of the 2nd Agent
...
language models,” in Proceedings of the Advances Conference in
...
search,” in Proceedings of the 2023 AutoML Conference, 2023.
...
tional Workshop on Genetic Improvement.
...
tional Symposium on Search Based Software Engineering.
Springer,
2023, pp. 153–159.
